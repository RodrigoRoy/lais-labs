<template>
  <v-card>
    ...
    <v-carousel hide-delimiters :show-arrows="laboratorioSelected.images.src.length > 1 ? 'hover' : false" cycle height="300" v-show="laboratorioSelected.images.src.length > 0" class="my-4">
    ...
    <!-- REFERENCIA AL VIDEO -->
    <iframe width="100%" height="300" class="my-4" src="https://www.youtube.com/embed/xheOSRBpfPs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <v-card-actions>
      ...
      <!-- CONTACTO - EMAIL -->
      <v-btn v-if="laboratorioSelected.contact.mail" :href="`mailto:${laboratorioSelected.contact.mail}`" target="_blank" icon size="medium" variant="plain" color="primary">
